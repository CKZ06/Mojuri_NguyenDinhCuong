...
export const Home4BodyClass = 'home home-4 title-4'
                ...
                <section className="section m-b-70">
                  ...
                  <div className="block block-video">
                    ...
                    <div className="video-caption">
                      ...
                      <a className="button button-white animation-horizontal" href="shop-grid-left.html">
                        DISCOVER NOW
                      </a>
                    </div>
                  </div>
                          ...
                          <div className="section-column left">
                            <div className="intro-wrap">
                              ...
                              <div className="intro-btn">
                                <a href="shop-grid-left.html" className="button button-outline border-black animation-horizontal">
                                  Read more
                                </a>
                              </div>
                            </div>
