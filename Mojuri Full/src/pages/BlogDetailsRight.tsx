...
export const BlogDetailsRightBodyClass = 'blog'

export default function BlogDetailsRight() {
  return (
    <>
                            ...
                            <div className="comment-form">
                              ...
                              <form action="#" method="post" className="row" noValidate>
                                ...
                                <div className="form-group col-md-6 col-sm-6">
                                  <input id="author" placeholder="Your Name *" name="author" type="text" value="" size={30} className="form-control" />
                                </div>
                                <div className="form-group col-md-6 col-sm-6">
                                  <input id="email" placeholder="Your Email *" name="email" type="text" value="" size={30} className="form-control" />
                                </div>
                                <div className="form-group col-md-12 col-sm-12">
                                  <input id="url" name="url" placeholder="Website" type="text" value="" size={30} className="form-control" />
                                </div>
                                <div className="form-group col-md-12">
                                  <input name="submit" type="submit" id="submit" className="button button-outline border-black" value="Post Comment" />
                                </div>
                              </form>
                            </div>
                          </div>
                        ...
                        <div className="block block-post-search">
                          ...
                          <div className="block-content">
                            <form method="get" className="search-from" action="#">
                              <input type="text" value="" name="s" className="s" placeholder="Search..." />
