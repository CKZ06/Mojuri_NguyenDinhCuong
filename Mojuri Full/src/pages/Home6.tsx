...
export const Home6BodyClass = 'home home-6 title-6'
                        ...
                        <div className="item-content">
                          ...
                          <div className="item-info horizontal-start vertical-middle">
                            <div className="content">
                              ...
                              <a className="button-slider button button-primary padding-large" href="shop-grid-left.html">
                                Shop Now
                              </a>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          <div className="col-md-4">
                            <div className="text-wrap">
                              ...
                              <a href="shop-grid-left.html" className="button button-outline border-black thick-border animation-horizontal">
                                All Categories
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="lookbook-container">
                            <div className="lookbook-content">
                              <div className="item">
                                ...
                                <div className="item-lookbook" style={{left: "52.97%", top: "22.31%"} as CSSProperties}>
                                  <span className="number-lookbook">
                                    1
                                  </span>
                                  <div className="content-lookbook" style={{right: "35px", top: "10px"} as CSSProperties}>
                                ...
                                <div className="item-lookbook" style={{left: "68.3%", top: "70.95%"} as CSSProperties}>
                                  <span className="number-lookbook">
                                    1
                                  </span>
