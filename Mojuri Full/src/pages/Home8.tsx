...
export const Home8BodyClass = 'home home-8 title-8'
                        ...
                        <div className="item-content">
                          ...
                          <div className="item-info horizontal-center vertical-middle text-center">
                            <div className="content">
                              ...
                              <a className="button-slider button button-outline border-black thick-border" href="shop-grid-left.html">
                                SHOP NOW
                              </a>
                            </div>
                          </div>
                      ...
                      <div className="block-widget-wrap">
                        <ul className="nav nav-tabs">
                          <li className="nav-item">
                            <a className="nav-link active" data-toggle="tab" href="#beauty-ingenuity" role="tab">
                              Beauty &amp; Ingenuity
                            </a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link" data-toggle="tab" href="#ear-stack" role="tab">
                              Ear Stack Magic
                            </a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link" data-toggle="tab" href="#wristwear-essentials" role="tab">
                              ...
                              <div className="section-column left">
                                <div className="intro-wrap">
                                  ...
                                  <div className="intro-btn">
                                    <a href="shop-grid-left.html" className="button button-outline border-black thick-border animation-horizontal hover-opacity">
                                      Shop Now
                                    </a>
                                  </div>
                                </div>
                          ...
                          <div className="col-md-4 sm-m-b-50">
                            <div className="box">
                              <div className="box-icon animation-horizontal">
                                <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.998 511.998" style={{enableBackground: "new 0 0 511.998 511.998"} as CSSProperties}>
                                    <g>
                                      <g>
                          ...
                          <div className="col-md-4 sm-m-b-50">
                            <div className="box">
                              <div className="box-icon icon-2 animation-horizontal">
                                <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 508 508" style={{enableBackground: "new 0 0 508 508"} as CSSProperties}>
                                    <g>
                                      <g>
                          ...
                          <div className="col-md-4">
                            <div className="box">
                              <div className="box-icon icon-3 animation-horizontal">
                                <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{enableBackground: "new 0 0 512 512"} as CSSProperties}>
                                    <g>
                                      <g>
