...
export const Home3BodyClass = 'home home-3 title-3'
                        ...
                        <div className="col-md-4 sm-m-b-50">
                          <div className="box">
                            <div className="box-icon">
                              <span>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style={{enableBackground: "new 0 0 512 512"} as CSSProperties} xmlSpace="preserve">
                                  <g>
                                    <g>
                        ...
                        <div className="col-md-4 sm-m-b-50">
                          <div className="box">
                            <div className="box-icon icon-2">
                              <span>
                                <svg xmlns="http://www.w3.org/2000/svg" height="459pt" viewBox="-5 0 459 459.648" width="459pt">
                                  <path d="m416.324219 293.824219c0 26.507812-21.492188 48-48 48h-313.375l63.199219-63.199219-22.625-22.625-90.511719 90.511719c-6.246094 6.25-6.246094 16.375 0 22.625l90.511719 90.511719 22.625-22.625-63.199219-63.199219h313.375c44.160156-.054688 79.945312-35.839844 80-80v-64h-32zm0 0"></path>
                                  <path d="m32.324219 165.824219c0-26.511719 21.488281-48 48-48h313.375l-63.199219 63.199219 22.625 22.625 90.511719-90.511719c6.246093-6.25 6.246093-16.375 0-22.625l-90.511719-90.511719-22.625 22.625 63.199219 63.199219h-313.375c-44.160157.050781-79.949219 35.839843-80 80v64h32zm0 0"></path>
                                </svg>
                              </span>
                            </div>
                            <div className="box-title-wrap">
                        ...
                        <div className="item-content">
                          ...
                          <div className="item-info horizontal-start vertical-middle">
                            <div className="content">
                              ...
                              <a className="button button-slider button-white" href="shop-grid-left.html">
                                SHOP NOW
                              </a>
                            </div>
                          </div>
                            ...
                            <div className="item item-product-cat">
                              <div className="item-product-cat-content">
                                ...
                                <div className="product-cat-content-info">
                                  <a className="item-title" href="shop-grid-left.html">
                                    Bracelets
                                  </a>
                                </div>
                              </div>
                              ...
                              <div className="lookbook-container">
                                <div className="lookbook-content">
                                  <div className="item">
                                    ...
                                    <div className="item-lookbook" style={{left: "43%", top: "77%"} as CSSProperties}>
                                      <span className="number-lookbook">
                                        1
                                      </span>
                                      <div className="content-lookbook" style={{left: "35px", bottom: "10px"} as CSSProperties}>
                            ...
                            <div className="col-md-6 col-text">
                              <div className="lookbook-intro-wrap position-center text-center">
                                <div className="lookbook-intro">
                                  ...
                                  <a href="shop-grid-left.html" className="button button-primary animation-horizontal">
                                    SHOP NOW
                                  </a>
                                </div>
                              </div>
                              ...
                              <div className="lookbook-container">
                                <div className="lookbook-content">
                                  <div className="item">
                                    ...
                                    <div className="item-lookbook" style={{right: "25%", top: "50%"} as CSSProperties}>
                                      <span className="number-lookbook">
                                        1
                                      </span>
                                      <div className="content-lookbook" style={{right: "35px", bottom: "10px"} as CSSProperties}>
                                        <div className="item-thumb">
                                          <a href="shop-details.html">
                          ...
                          <div className="section-column left">
                            <div className="intro-wrap">
                              ...
                              <div className="intro-btn">
                                <a href="page-about.html" className="button button-primary animation-horizontal">
                                  About Us
                                </a>
                              </div>
                            </div>
