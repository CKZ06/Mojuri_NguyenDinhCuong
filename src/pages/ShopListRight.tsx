...
export const ShopListRightBodyClass = 'shop'
                          ...
                          <div className="products-topbar-right">
                            ...
                            <ul className="layout-toggle nav nav-tabs">
                              <li className="nav-item">
                                <a className="layout-grid nav-link" data-toggle="tab" href="#layout-grid" role="tab">
                              ...
                              <li className="nav-item">
                                <a className="layout-list nav-link active" data-toggle="tab" href="#layout-list" role="tab">
                                  <span className="icon-column">
                                    <span className="layer first">
                                      <span></span>
                                      <span></span>
                          ...
                          <div className="block-content">
                            <ul className="filter-items color">
                              <li>
                                <a href="shop-grid-left.html">
                                  <span className="color-wrap">
                                    <span className="color antique"></span>
                                    Antique
                                  </span>
                                  <span className="count">
                                    3
                              ...
                              <li>
                                <a href="shop-grid-left.html">
                                  <span className="color-wrap">
                                    <span className="color bone"></span>
                                    Bone
                                  </span>
                                  <span className="count">
                                    2
                              ...
                              <li>
                                <a href="shop-grid-left.html">
                                  <span className="color-wrap">
                                    <span className="color crimson"></span>
                                    Crimson
                                  </span>
                                  <span className="count">
                                    8
                              ...
                              <li>
                                <a href="shop-grid-left.html">
                                  <span className="color-wrap">
                                    <span className="color grullo"></span>
                                    Grullo
                                  </span>
                                  <span className="count">
                                    4
