...
export const Home5BodyClass = 'home home-5'
                  ...
                  <div className="block block-parallax bg-img-1 bg-top-center">
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="content">
                            ...
                            <a className="button button-white button-outline thick-border button-arrow animation-horizontal" href="shop-grid-left.html">
                              Explore All
                            </a>
                          </div>
                        </div>
                    ...
                    <div className="go-to-section">
                      <div className="go-to-button">
                        <a className="scroll-button" href="#section-2">
                          Scroll Down
                        </a>
                      </div>
